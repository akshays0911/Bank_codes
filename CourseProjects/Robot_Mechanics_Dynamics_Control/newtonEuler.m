...
%%
% Checking for Rotary or Prismatic Joints and assigning values
for i = 1:6
    a(i) = linkList(i).a;
    ...
    if isRotary(i) == 0                  % if it is not rotary joint               
        ...
        d(i) = linkList(i).d;            % if it is rotary joint
        theta(i) = paramList(i);         % assigning the values for rotary jooint
...
%%
% Angular Velocity for each link
w = zeros(3,7);
...
%%
% Angular Acceleartion for each link
w_dot = zeros(3,7);
...
%%
% Linear Acceleration for each link
dd_ddot = zeros(3,7);
...
%%
% Centre of mass positon for each link
rcom_base = zeros(3,6);
...
%%
% First Time derivative of centre of mass
...
%%
% Second time derivative of centre of mass
